...
from python_execution_server.types.message import EventMessage
from python_execution_server.types import events as ev
from python_execution_server.workflowsgrpc.converters import convert_from_grpc, convert_to_grpc


logger = logging.getLogger(__name__)

if TYPE_CHECKING:  # Only imported for static type checking
    from python_execution_server.workflowsgrpc.events_pb2_grpc import EventServiceStub
...
class GrpcCommunicator:
    ...
    async def _run(self) -> None:
        from python_execution_server.workflowsgrpc import events_pb2_grpc  # type: ignore
