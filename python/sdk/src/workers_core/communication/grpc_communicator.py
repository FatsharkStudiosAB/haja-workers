...
from workers_core.types import events as ev
from workers_core.workflowsgrpc.converters import convert_from_grpc, convert_to_grpc


logger = logging.getLogger(__name__)

if TYPE_CHECKING:  # Only imported for static type checking
    from workers_core.workflowsgrpc.events_pb2_grpc import EventServiceStub
...
class GrpcCommunicator:
    ...
    async def _run(self) -> None:
        from workers_core.workflowsgrpc import events_pb2_grpc  # type: ignore
